public class Solution {
    public List<List<String>> solveNQueens(int n) {
        ...
        check(ans, board, n, used2, used3, used4);
        return ans;
    }
    
    void check(List<List<String>> ans, char[][] board, int n, boolean[] used2, boolean[] used3, boolean[] used4) {
        
        int i = board.length-n;
        for (int j=0; j<board[0].length; j++) {
            ...
            if (!(used2[j] || used3[i+j] || used4[i+board.length-1-j])) {
                ...
                if (n-1 == 0) {
                    ...
                    check(ans, board, n-1, used2, used3, used4);
                }
